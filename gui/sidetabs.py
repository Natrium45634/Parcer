...
GROUPS = (
    ("Мир", ("Летопись", "Карта мира", "Эпохи", "Земли", "Как менялся мир",
             "Итоги")),
    ("Державы", ("Страны", "Города", "Жизнь городов", "Племена и лагеря",
                 "Державы и народы", "Политика", "Законы")),
    ("Война", ("Войны", "Походы", "Крепости и роты", "Смуты", "Заговоры",
               "Посольства и тайны")),
    ("Люди", ("Правители", "Знать", "Знатные рода", "Личности",
              "Судьбы людей", "Память и связи")),
    ("Народы", ("Народы", "Языки", "Переселения", "Растворение народов")),
    ("Вера", ("Веры", "Пантеон")),
    ("Хозяйство", ("Хозяйство", "Гильдии", "Ремёсла")),
    ("Чудеса", ("Сказания", "Были", "Чудовища", "Вещи", "Места",
                "Своды и легенды")),

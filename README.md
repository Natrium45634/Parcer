...
### Блок 23 — свой генератор гексагональных карт

Карту больше не нужно брать из посторонней программы. «Хронист» делает
её сам, в том же формате `.world`:

* **плиты** — там, где сходятся, растут хребты; где расходятся, лежат
  впадины;
* **высота** — слоистый шум поверх плит, уровень моря режет сушу;
* **тепло** — от широты минус высота: шесть с половиной градусов на
  километр;
* **влага** — ветер несёт её с воды и теряет на подъёмах, за хребтом
  остаётся дождевая тень;
* **реки** — вода стекает по уклону и прорезает русло там, где её
  набирается много;
* **биомы** — тепло и влага по таблице Уиттекера: от ледника до
  тропического дождевого леса;
* **прочее** — плодородие, руды, магия, дикость, местные угрозы,
  логова древних существ и лента климата на всю историю.

Карту видно прямо в мастере, её можно перебрасывать, пока не
понравится, и сохранять файлом — в том числе чтобы открыть в
картогенераторе.

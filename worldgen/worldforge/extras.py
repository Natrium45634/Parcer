...
def climate(seed: str) -> dict:
    ...
    Восемь видов перемен: ледниковый период, великое потепление,
    импактная и вулканическая зима, великая засуха, плювиал, всплеск
    маны и великая зима. Порядок бросков закреплён: он и определяет,
    какая лента выпадет этому сиду.
    """

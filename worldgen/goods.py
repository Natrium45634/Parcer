...
GOOD_GEN = {
    GRAIN: "хлеба", MEAT: "скота", FISH: "рыбы", TIMBER: "леса",
    STONE: "камня", METAL: "металла", SALT: "соли", WOOL: "шерсти",
    FURS: "мехов", WINE: "вина", SPICE: "пряностей", GEMS: "самоцветов",
    REAGENTS: "чародейных снадобий",
}


def gen(good: str) -> str:
    """Товар в родительном падеже: «год без соли»."""

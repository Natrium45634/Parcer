...
TOLL_LINES = (
    ...
    "Всего за ним числится %(kills)s.",
    "Список имён, что читают по нему, дорос до %(kills)s.",
    "Считают убитых на камне у дороги: %(kills)s.",
    "Дань его — %(kills)s, и платят её который год.",
    "Старики сбиваются со счёта на %(kills)s.",
    "В поминальной песне теперь %(kills)s.",
    "Тем, кого он взял, счёт уже %(kills)s.",
    "Кладбище у той дороги приняло %(kills)s.",
    "Числят за ним %(kills)s — и это только названные.",
    "Счёт круглый и страшный: %(kills)s.",
)
